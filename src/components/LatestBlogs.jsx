  ...
  return (
    <section className="mx-auto mt-16 max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8 lg:grid-cols-3">
        {/* Blog Post Card 1 */}
        <article className="group flex flex-col h-full overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm dark:border-slate-800/80 dark:bg-[#0D1527] transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="flex flex-col p-5 grow">
            ...
            <p className="font-body mt-2 text-xs leading-relaxed text-slate-500 dark:text-slate-400 line-clamp-2">
              Essential warmup routines, protective gear guidelines, and injury
              prevention strategies to ensure peak performance on the field.
            </p>
          </div>
        </article>
        ...
        <article className="group flex flex-col h-full overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm dark:border-slate-800/80 dark:bg-[#0D1527] transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="flex flex-col p-5 grow">
            ...
            <p className="font-body mt-2 text-xs leading-relaxed text-slate-500 dark:text-slate-400 line-clamp-2">
              Discover high-intensity athletic activities that enhance
              cardiovascular endurance, build core agility, and boost your
              overall stamina.
            </p>
          </div>
        </article>
        ...
        <article className="group flex flex-col h-full overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm dark:border-slate-800/80 dark:bg-[#0D1527] transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="flex flex-col p-5 grow">
            ...
            <p className="font-body mt-2 text-xs leading-relaxed text-slate-500 dark:text-slate-400 line-clamp-2">
              Optimize your meal planning with professional macro breakdowns,
              hydration tactics, and efficient recovery food options.
            </p>
          </div>
        </article>
      </div>
