...
export default function WhyChooseUs() {
  // Animation variants for the individual feature items
  const itemVariants = {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <motion.div 
        ...
        className="grid grid-cols-1 md:grid-cols-3 bg-white dark:bg-[#0D1527] border border-slate-100 dark:border-slate-800/80 rounded-full py-3 px-6 shadow-xs max-w-5xl mx-auto items-center"
      >
        
        <motion.div variants={itemVariants} className="flex items-center justify-center gap-3 py-2 md:py-1">
        ...
        <motion.div 
          ...
          className="flex items-center justify-center gap-3 py-2 md:py-1 border-t md:border-t-0 md:border-x border-slate-100 dark:border-slate-800/60"
        >
        ...
        <motion.div 
          variants={itemVariants} 
          className="flex items-center justify-center gap-3 py-2 md:py-1 border-t md:border-t-0 border-slate-100 dark:border-slate-800/60"
        >
